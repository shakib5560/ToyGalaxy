...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('order_id', models.CharField(default='879B8', editable=False, max_length=50, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('image', models.ImageField(blank=True, null=True, upload_to='product_images/')),
                ('galary_id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False, unique=True)),
                ('alttag', models.CharField(blank=True, max_length=500, null=True)),
